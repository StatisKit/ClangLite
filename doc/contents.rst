...
- A `PDF <../latex/pyclanglite.pdf>`_ version of |pyclanglite| documentation is 
  available.

.. seealso::

   More documentation can be found on the
   `openalea <http://openalea.gforge.inria.fr/dokuwiki/doku.php?id=packages::pyclanglite:pyclanglite>`__ wiki.
