...
void class_clang_injected_class_name_type()
{
        ...
        boost::python::class_< class ::clang::InjectedClassNameType, class ::clang::InjectedClassNameType *, boost::python::bases< class ::clang::Type >, boost::noncopyable >("InjectedClassNameType", boost::python::no_init);
}