...
void wrapper_47d43e4eda7252d2bec0204a93977671()
{
    ...
    bool  (*method_pointer_b7312164f11d581eba4e01fdb081bd00)(class ::clang::Type  const *) = ::clang::DependentSizedArrayType::classof;
    bool  (::clang::DependentSizedArrayType::*method_pointer_d40f006b1b165aa49d4ebef4dceacbb0)() const = &::clang::DependentSizedArrayType::isSugared;
    ...
    class_47d43e4eda7252d2bec0204a93977671.def("classof", method_pointer_b7312164f11d581eba4e01fdb081bd00, "");
    class_47d43e4eda7252d2bec0204a93977671.def("is_sugared", method_pointer_d40f006b1b165aa49d4ebef4dceacbb0, "");
