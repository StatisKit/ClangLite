...
void class_clang_non_type_template_parm_decl()
{
        ...
        boost::python::class_< class ::clang::NonTypeTemplateParmDecl, class ::clang::NonTypeTemplateParmDecl *, boost::python::bases< class ::clang::DeclaratorDecl >, boost::noncopyable >("NonTypeTemplateParmDecl", boost::python::no_init);
}