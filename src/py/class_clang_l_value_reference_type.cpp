...
void class_clang_l_value_reference_type()
{
        ...
        boost::python::class_< class ::clang::LValueReferenceType, class ::clang::LValueReferenceType *, boost::python::bases< class ::clang::ReferenceType >, boost::noncopyable >("LValueReferenceType", boost::python::no_init);
}