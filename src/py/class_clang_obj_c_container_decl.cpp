...
void class_clang_obj_c_container_decl()
{
        ...
        boost::python::class_< class ::clang::ObjCContainerDecl, class ::clang::ObjCContainerDecl *, boost::python::bases< class ::clang::NamedDecl, class ::clang::DeclContext >, boost::noncopyable >("ObjCContainerDecl", boost::python::no_init);
}