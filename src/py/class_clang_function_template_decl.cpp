...
void class_clang_function_template_decl()
{
        ...
        boost::python::class_< class ::clang::FunctionTemplateDecl, class ::clang::FunctionTemplateDecl *, boost::python::bases< class ::clang::RedeclarableTemplateDecl >, boost::noncopyable >("FunctionTemplateDecl", boost::python::no_init);
}