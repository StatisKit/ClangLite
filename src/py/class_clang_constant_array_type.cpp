...
void class_clang_constant_array_type()
{
        ...
        boost::python::class_< class ::clang::ConstantArrayType, class ::clang::ConstantArrayType *, boost::python::bases< class ::clang::ArrayType >, boost::noncopyable >("ConstantArrayType", boost::python::no_init);
}