...
void wrapper_3bcdbbe507dd5ad29df9e33aca4e435f()
{
    ...
    bool  (::clang::QualType::*method_pointer_3b772a13bc9f5ec9916dfb01ec22b6f2)(const class ::clang::ASTContext  &) const = &::clang::QualType::isCXX11PODType;
    bool  (::clang::QualType::*method_pointer_323a1bc884245ad0a6dc9fb4d72eb686)(const class ::clang::ASTContext  &) const = &::clang::QualType::isCXX98PODType;
    ...
    bool  (::clang::QualType::*method_pointer_99a809ebe70e574ca7e1b3994a0a1c83)(const class ::clang::ASTContext  &) const = &::clang::QualType::isConstant;
    ...
    bool  (::clang::QualType::*method_pointer_cf435c693f705a0884c80d26b89cadc9)(const class ::clang::ASTContext  &) const = &::clang::QualType::isPODType;
    bool  (::clang::QualType::*method_pointer_da25f1dd25d45a62be2295789b1e84d8)() const = &::clang::QualType::isRestrictQualified;
    bool  (::clang::QualType::*method_pointer_74b71635d2175c968c678819d4fd16f6)(const class ::clang::ASTContext  &) const = &::clang::QualType::isTrivialType;
    bool  (::clang::QualType::*method_pointer_cf9c6509e5dc5f9c8cc55f9f6e6e0cfb)(const class ::clang::ASTContext  &) const = &::clang::QualType::isTriviallyCopyableType;
