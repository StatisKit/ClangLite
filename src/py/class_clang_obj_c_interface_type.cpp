...
void class_clang_obj_c_interface_type()
{
        ...
        boost::python::class_< class ::clang::ObjCInterfaceType, class ::clang::ObjCInterfaceType *, boost::python::bases< class ::clang::ObjCObjectType >, boost::noncopyable >("ObjCInterfaceType", boost::python::no_init);
}