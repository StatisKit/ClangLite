...
void wrapper_ff7ccf9c3af754489bcda419bd00d838()
{
    ...
    boost::python::scope().attr("memory_core_foundation_objective_c") = ::clang::ento::categories::MemoryCoreFoundationObjectiveC;
}