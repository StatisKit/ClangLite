...
void class_clang_vector_type()
{
        ...
        boost::python::class_< class ::clang::VectorType, class ::clang::VectorType *, boost::python::bases< class ::clang::Type >, boost::noncopyable >("VectorType", boost::python::no_init);
}