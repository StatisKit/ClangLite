...
void class_clang_access_spec_decl()
{
        ...
        boost::python::class_< class ::clang::AccessSpecDecl, class ::clang::AccessSpecDecl *, boost::python::bases< class ::clang::Decl >, boost::noncopyable >("AccessSpecDecl", boost::python::no_init);
}