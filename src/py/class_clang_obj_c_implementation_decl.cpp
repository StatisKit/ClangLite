...
void class_clang_obj_c_implementation_decl()
{
        ...
        boost::python::class_< class ::clang::ObjCImplementationDecl, class ::clang::ObjCImplementationDecl *, boost::python::bases< class ::clang::ObjCImplDecl >, boost::noncopyable >("ObjCImplementationDecl", boost::python::no_init);
}