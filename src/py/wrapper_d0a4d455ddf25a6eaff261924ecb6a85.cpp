...
void wrapper_d0a4d455ddf25a6eaff261924ecb6a85()
{
    ...
    bool  (*method_pointer_daddf18ec2f05c4b9bcbb5b0eb20d5de)(class ::clang::Type  const *) = ::clang::FunctionNoProtoType::classof;
    bool  (::clang::FunctionNoProtoType::*method_pointer_1be85555ef6b5ee5a35ba379deb715de)() const = &::clang::FunctionNoProtoType::isSugared;
    ...
    class_d0a4d455ddf25a6eaff261924ecb6a85.def("classof", method_pointer_daddf18ec2f05c4b9bcbb5b0eb20d5de, "");
    class_d0a4d455ddf25a6eaff261924ecb6a85.def("is_sugared", method_pointer_1be85555ef6b5ee5a35ba379deb715de, "");
