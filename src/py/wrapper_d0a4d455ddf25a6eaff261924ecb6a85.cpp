...
void wrapper_d0a4d455ddf25a6eaff261924ecb6a85()
{
    ...
    bool  (*method_pointer_935825a9b2a8544c8db9c81a4c23f5c0)(class ::clang::Type  const *) = ::clang::FunctionNoProtoType::classof;
    bool  (::clang::FunctionNoProtoType::*method_pointer_e1432dfec795558dade182800672c32f)() const = &::clang::FunctionNoProtoType::isSugared;
    ...
    class_d0a4d455ddf25a6eaff261924ecb6a85.def("classof", method_pointer_935825a9b2a8544c8db9c81a4c23f5c0, "");
    class_d0a4d455ddf25a6eaff261924ecb6a85.def("is_sugared", method_pointer_e1432dfec795558dade182800672c32f, "");
