...
void class_clang_obj_c_object_type()
{
        ...
        boost::python::class_< class ::clang::ObjCObjectType, class ::clang::ObjCObjectType *, boost::python::bases< class ::clang::Type >, boost::noncopyable >("ObjCObjectType", boost::python::no_init);
}