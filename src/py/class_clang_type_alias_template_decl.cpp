...
void class_clang_type_alias_template_decl()
{
        ...
        boost::python::class_< class ::clang::TypeAliasTemplateDecl, class ::clang::TypeAliasTemplateDecl *, boost::python::bases< class ::clang::RedeclarableTemplateDecl >, boost::noncopyable >("TypeAliasTemplateDecl", boost::python::no_init);
}