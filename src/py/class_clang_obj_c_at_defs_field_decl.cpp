...
void class_clang_obj_c_at_defs_field_decl()
{
        ...
        boost::python::class_< class ::clang::ObjCAtDefsFieldDecl, class ::clang::ObjCAtDefsFieldDecl *, boost::python::bases< class ::clang::FieldDecl >, boost::noncopyable >("ObjCAtDefsFieldDecl", boost::python::no_init);
}