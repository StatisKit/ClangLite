...
void class_clang_obj_c_property_decl()
{
        ...
        boost::python::class_< class ::clang::ObjCPropertyDecl, class ::clang::ObjCPropertyDecl *, boost::python::bases< class ::clang::NamedDecl >, boost::noncopyable >("ObjCPropertyDecl", boost::python::no_init);
}