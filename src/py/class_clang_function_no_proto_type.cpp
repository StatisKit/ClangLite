...
void class_clang_function_no_proto_type()
{
        ...
        boost::python::class_< class ::clang::FunctionNoProtoType, class ::clang::FunctionNoProtoType *, boost::python::bases< class ::clang::FunctionType >, boost::noncopyable >("FunctionNoProtoType", boost::python::no_init);
}