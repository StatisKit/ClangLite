...
void wrapper_e6f4659cd31f536d8a173fe6b97a9e5a()
{
    ...
    bool  (*method_pointer_e45ca38fd0e75e65813479103fcf4f3d)(class ::clang::Type  const *) = ::clang::IncompleteArrayType::classof;
    bool  (::clang::IncompleteArrayType::*method_pointer_757a43eb060f5e32beba098fd4ca90b9)() const = &::clang::IncompleteArrayType::isSugared;
    ...
    class_e6f4659cd31f536d8a173fe6b97a9e5a.def("classof", method_pointer_e45ca38fd0e75e65813479103fcf4f3d, "");
    class_e6f4659cd31f536d8a173fe6b97a9e5a.def("is_sugared", method_pointer_757a43eb060f5e32beba098fd4ca90b9, "");
