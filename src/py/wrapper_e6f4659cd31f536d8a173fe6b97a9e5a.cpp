...
void wrapper_e6f4659cd31f536d8a173fe6b97a9e5a()
{
    ...
    bool  (*method_pointer_66c6222f7ef056348590a1a52b23e95f)(class ::clang::Type  const *) = ::clang::IncompleteArrayType::classof;
    bool  (::clang::IncompleteArrayType::*method_pointer_8e289477542a54fbad2887b80ea1ceab)() const = &::clang::IncompleteArrayType::isSugared;
    ...
    class_e6f4659cd31f536d8a173fe6b97a9e5a.def("classof", method_pointer_66c6222f7ef056348590a1a52b23e95f, "");
    class_e6f4659cd31f536d8a173fe6b97a9e5a.def("is_sugared", method_pointer_8e289477542a54fbad2887b80ea1ceab, "");
