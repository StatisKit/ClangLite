...
void wrapper_e6f4659cd31f536d8a173fe6b97a9e5a()
{
    ...
    bool  (*method_pointer_39ca09249aa25f5daab60bd17c3e7b94)(class ::clang::Type  const *) = ::clang::IncompleteArrayType::classof;
    bool  (::clang::IncompleteArrayType::*method_pointer_420fc4e80fe45b1f84698695b687d0e1)() const = &::clang::IncompleteArrayType::isSugared;
    ...
    class_e6f4659cd31f536d8a173fe6b97a9e5a.def("classof", method_pointer_39ca09249aa25f5daab60bd17c3e7b94, "");
    class_e6f4659cd31f536d8a173fe6b97a9e5a.def("is_sugared", method_pointer_420fc4e80fe45b1f84698695b687d0e1, "");
