...
void wrapper_e6f4659cd31f536d8a173fe6b97a9e5a()
{
    ...
    bool  (*method_pointer_f6a257dda1cd525d8d34311af5aac561)(class ::clang::Type  const *) = ::clang::IncompleteArrayType::classof;
    bool  (::clang::IncompleteArrayType::*method_pointer_b296bb6acfd5544b895979788a14553a)() const = &::clang::IncompleteArrayType::isSugared;
    ...
    class_e6f4659cd31f536d8a173fe6b97a9e5a.def("classof", method_pointer_f6a257dda1cd525d8d34311af5aac561, "");
    class_e6f4659cd31f536d8a173fe6b97a9e5a.def("is_sugared", method_pointer_b296bb6acfd5544b895979788a14553a, "");
