...
namespace boost
{
    template <> class ::clang::CXXConstructorDecl const volatile * get_pointer<class ::clang::CXXConstructorDecl const volatile >(class ::clang::CXXConstructorDecl const volatile *c) { return c; }
}
    #endif
#endif
...
void wrapper_69ef5751cb19567085dced299c047c9f()
{
    ...
    class_69ef5751cb19567085dced299c047c9f.def("get_target_constructor", method_pointer_755bbc08e36f525eb88f6723f0907ef7, boost::python::return_value_policy< boost::python::reference_existing_object >(), "When this constructor delegates to another, retrieve the target.\n\n:Return Type:\n    :py:class:`clanglite.clang.CXXConstructorDecl`\n\n");
    ...
    class_69ef5751cb19567085dced299c047c9f.def("classof_kind", method_pointer_25cdcd0db32050a9abe13e3b4062ca7b, "");
    ...
    if(autowig::Held< class ::clang::CXXConstructorDecl >::is_class)
    {
        boost::python::implicitly_convertible< autowig::Held< class ::clang::CXXConstructorDecl >::Type, autowig::Held< class ::clang::CXXMethodDecl >::Type >();
        //boost::python::objects::class_value_wrapper< autowig::Held< class ::clang::CXXConstructorDecl >::Type, boost::python::objects::make_ptr_instance< class ::clang::CXXConstructorDecl, boost::python::objects::pointer_holder< autowig::Held< class ::clang::CXXConstructorDecl >::Type, class ::clang::CXXConstructorDecl > > >();
    }
