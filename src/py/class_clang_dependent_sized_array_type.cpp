...
void class_clang_dependent_sized_array_type()
{
        ...
        boost::python::class_< class ::clang::DependentSizedArrayType, class ::clang::DependentSizedArrayType *, boost::python::bases< class ::clang::ArrayType >, boost::noncopyable >("DependentSizedArrayType", boost::python::no_init);
}