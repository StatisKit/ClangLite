...
void class_clang_dependent_template_specialization_type()
{
        ...
        boost::python::class_< class ::clang::DependentTemplateSpecializationType, class ::clang::DependentTemplateSpecializationType *, boost::noncopyable >("DependentTemplateSpecializationType", boost::python::no_init);
}