...
void class_clang_member_pointer_type()
{
        ...
        boost::python::class_< class ::clang::MemberPointerType, class ::clang::MemberPointerType *, boost::python::bases< class ::clang::Type >, boost::noncopyable >("MemberPointerType", boost::python::no_init);
}