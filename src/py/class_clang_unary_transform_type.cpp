...
void class_clang_unary_transform_type()
{
        ...
        boost::python::class_< class ::clang::UnaryTransformType, class ::clang::UnaryTransformType *, boost::python::bases< class ::clang::Type >, boost::noncopyable >("UnaryTransformType", boost::python::no_init);
}