...
void wrapper_fa70cbf14eb958718b2fd94051e17863()
{
    ...
    bool  (::clang::Type::*method_pointer_91ab97a4015857e9a45c697af057ec23)(class ::clang::ASTContext &) const = &::clang::Type::isIntegralType;
    ...
    bool  (::clang::Type::*method_pointer_b8a35aea500b570899b5104536381719)() const = &::clang::Type::isImage1dT;
    bool  (::clang::Type::*method_pointer_c2be52fa04025fd08b55ca841a79debe)() const = &::clang::Type::isImage1dArrayT;
    bool  (::clang::Type::*method_pointer_e6e691611f835ce18fbb203e0b6ba661)() const = &::clang::Type::isImage1dBufferT;
    bool  (::clang::Type::*method_pointer_e78dd6a6cf015591ab637ad1c0120030)() const = &::clang::Type::isImage2dT;
    bool  (::clang::Type::*method_pointer_5958e7fb1cee59e1be8794d26e999739)() const = &::clang::Type::isImage2dArrayT;
    bool  (::clang::Type::*method_pointer_deb15b5529095e0c885cc6d3321908af)() const = &::clang::Type::isImage2dDepthT;
    bool  (::clang::Type::*method_pointer_aa0454e5862456cd8099d95d5ae9242b)() const = &::clang::Type::isImage2dArrayDepthT;
    bool  (::clang::Type::*method_pointer_823c970327475c8d841005f3b13e5953)() const = &::clang::Type::isImage2dMSAAT;
    bool  (::clang::Type::*method_pointer_df43ae3124465046917911306ee0e851)() const = &::clang::Type::isImage2dArrayMSAAT;
    bool  (::clang::Type::*method_pointer_1b1e735d43a55a10836561fc1ee875fa)() const = &::clang::Type::isImage2dMSAATDepth;
    bool  (::clang::Type::*method_pointer_10670540390c53af92c1d8b24ccd9af4)() const = &::clang::Type::isImage2dArrayMSAATDepth;
    bool  (::clang::Type::*method_pointer_a5b86fc5a472536ab63eca5e3b9834ef)() const = &::clang::Type::isImage3dT;
    ...
    class_fa70cbf14eb958718b2fd94051e17863.def("is_integral_type", method_pointer_91ab97a4015857e9a45c697af057ec23, "");
    ...
    class_fa70cbf14eb958718b2fd94051e17863.def("is_image_1d_t", method_pointer_b8a35aea500b570899b5104536381719, "");
    class_fa70cbf14eb958718b2fd94051e17863.def("is_image_1d_array_t", method_pointer_c2be52fa04025fd08b55ca841a79debe, "");
    class_fa70cbf14eb958718b2fd94051e17863.def("is_image_1d_buffer_t", method_pointer_e6e691611f835ce18fbb203e0b6ba661, "");
    class_fa70cbf14eb958718b2fd94051e17863.def("is_image_2d_t", method_pointer_e78dd6a6cf015591ab637ad1c0120030, "");
    class_fa70cbf14eb958718b2fd94051e17863.def("is_image_2d_array_t", method_pointer_5958e7fb1cee59e1be8794d26e999739, "");
    class_fa70cbf14eb958718b2fd94051e17863.def("is_image_2d_depth_t", method_pointer_deb15b5529095e0c885cc6d3321908af, "");
    class_fa70cbf14eb958718b2fd94051e17863.def("is_image_2d_array_depth_t", method_pointer_aa0454e5862456cd8099d95d5ae9242b, "");
    class_fa70cbf14eb958718b2fd94051e17863.def("is_image_2d_msaat", method_pointer_823c970327475c8d841005f3b13e5953, "");
    class_fa70cbf14eb958718b2fd94051e17863.def("is_image_2d_array_msaat", method_pointer_df43ae3124465046917911306ee0e851, "");
    class_fa70cbf14eb958718b2fd94051e17863.def("is_image_2d_msaat_depth", method_pointer_1b1e735d43a55a10836561fc1ee875fa, "");
    class_fa70cbf14eb958718b2fd94051e17863.def("is_image_2d_array_msaat_depth", method_pointer_10670540390c53af92c1d8b24ccd9af4, "");
    class_fa70cbf14eb958718b2fd94051e17863.def("is_image_3d_t", method_pointer_a5b86fc5a472536ab63eca5e3b9834ef, "");
