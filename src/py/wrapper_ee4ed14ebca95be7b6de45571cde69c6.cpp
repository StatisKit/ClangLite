...
void wrapper_ee4ed14ebca95be7b6de45571cde69c6(pybind11::module& module)
{
    ...
    pybind11::class_<class ::clang::FunctionProtoType, autowig::HolderType< class ::clang::FunctionProtoType >::Type, class ::clang::FunctionType > class_ee4ed14ebca95be7b6de45571cde69c6(module, "FunctionProtoType", "");
    ...
    class_ee4ed14ebca95be7b6de45571cde69c6.def("get_exception_spec_decl", method_pointer_b86b82fdb78b5eb19e72012e2792fdd2, pybind11::return_value_policy::reference_internal, "If this function type has an exception specification which hasn’t been\ndetermined yet (either because it has not been evaluated or because it\nhas not been instantiated), this is the function whose exception\nspecification is represented by this type.\n\n:Return Type:\n    :cpp:class:`::clang::FunctionDecl`\n\n");
    class_ee4ed14ebca95be7b6de45571cde69c6.def("get_exception_spec_template", method_pointer_10674a0526505c36ae180b867b1ec04a, pybind11::return_value_policy::reference_internal, "If this function type has an uninstantiated exception specification,\nthis is the function whose exception specification should be\ninstantiated to find the exception specification for this type.\n\n:Return Type:\n    :cpp:class:`::clang::FunctionDecl`\n\n");
    ...
    class_ee4ed14ebca95be7b6de45571cde69c6.def("param_type_begin", method_pointer_128491a3add05122b30f4fd64cda0b07, pybind11::return_value_policy::reference_internal, "");
    class_ee4ed14ebca95be7b6de45571cde69c6.def("param_type_end", method_pointer_b4727c7672ab5855938da66d8eb475c6, pybind11::return_value_policy::reference_internal, "");
    class_ee4ed14ebca95be7b6de45571cde69c6.def("exception_begin", method_pointer_c0764b61d3165d71b301d7df526f8fea, pybind11::return_value_policy::reference_internal, "");
    class_ee4ed14ebca95be7b6de45571cde69c6.def("exception_end", method_pointer_d3f2b7fcd84d551ca494293821b5fc9e, pybind11::return_value_policy::reference_internal, "");
    ...
    class_ee4ed14ebca95be7b6de45571cde69c6.def_static("classof", method_pointer_90cd2e9fa2ab58c7b3af7a31371c9b11, "");
