...
void class_clang_pack_expansion_type()
{
        ...
        boost::python::class_< class ::clang::PackExpansionType, class ::clang::PackExpansionType *, boost::python::bases< class ::clang::Type >, boost::noncopyable >("PackExpansionType", boost::python::no_init);
}