...
void class_clang_friend_template_decl()
{
        ...
        boost::python::class_< class ::clang::FriendTemplateDecl, class ::clang::FriendTemplateDecl *, boost::python::bases< class ::clang::Decl >, boost::noncopyable >("FriendTemplateDecl", boost::python::no_init);
}