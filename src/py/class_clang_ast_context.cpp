...
void class_clang_ast_context()
{
        ...
        class ::clang::SourceManager & (::clang::ASTContext::*method_pointer_eb00afb4ec6a50b59f04d6e5aa4b6fc4)() = &::clang::ASTContext::getSourceManager;
        boost::python::class_< class ::clang::ASTContext, class ::clang::ASTContext *, boost::noncopyable >("ASTContext", boost::python::no_init)
            .def("get_source_manager", method_pointer_eb00afb4ec6a50b59f04d6e5aa4b6fc4, boost::python::return_value_policy< boost::python::reference_existing_object >());
}