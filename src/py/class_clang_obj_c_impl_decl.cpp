...
void class_clang_obj_c_impl_decl()
{
        ...
        boost::python::class_< class ::clang::ObjCImplDecl, class ::clang::ObjCImplDecl *, boost::python::bases< class ::clang::ObjCContainerDecl >, boost::noncopyable >("ObjCImplDecl", boost::python::no_init);
}