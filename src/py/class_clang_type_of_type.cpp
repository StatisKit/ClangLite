...
void class_clang_type_of_type()
{
        ...
        boost::python::class_< class ::clang::TypeOfType, class ::clang::TypeOfType *, boost::python::bases< class ::clang::Type >, boost::noncopyable >("TypeOfType", boost::python::no_init);
}