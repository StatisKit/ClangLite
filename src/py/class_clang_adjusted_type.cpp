...
void class_clang_adjusted_type()
{
        ...
        boost::python::class_< class ::clang::AdjustedType, class ::clang::AdjustedType *, boost::python::bases< class ::clang::Type >, boost::noncopyable >("AdjustedType", boost::python::no_init);
}