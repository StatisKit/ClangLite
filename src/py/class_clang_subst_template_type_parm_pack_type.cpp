...
void class_clang_subst_template_type_parm_pack_type()
{
        ...
        boost::python::class_< class ::clang::SubstTemplateTypeParmPackType, class ::clang::SubstTemplateTypeParmPackType *, boost::python::bases< class ::clang::Type >, boost::noncopyable >("SubstTemplateTypeParmPackType", boost::python::no_init);
}