...
void class_clang_enum_constant_decl()
{
        ...
        boost::python::class_< class ::clang::EnumConstantDecl, class ::clang::EnumConstantDecl *, boost::python::bases< class ::clang::ValueDecl >, boost::noncopyable >("EnumConstantDecl", boost::python::no_init);
}