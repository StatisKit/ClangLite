...
void class_clang_obj_c_protocol_decl()
{
        ...
        boost::python::class_< class ::clang::ObjCProtocolDecl, class ::clang::ObjCProtocolDecl *, boost::python::bases< class ::clang::ObjCContainerDecl >, boost::noncopyable >("ObjCProtocolDecl", boost::python::no_init);
}