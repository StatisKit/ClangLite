...
void class_clang_redeclarable_template_decl()
{
        ...
        boost::python::class_< class ::clang::RedeclarableTemplateDecl, class ::clang::RedeclarableTemplateDecl *, boost::python::bases< class ::clang::TemplateDecl >, boost::noncopyable >("RedeclarableTemplateDecl", boost::python::no_init);
}