...
void class_clang_reference_type()
{
        ...
        boost::python::class_< class ::clang::ReferenceType, class ::clang::ReferenceType *, boost::python::bases< class ::clang::Type >, boost::noncopyable >("ReferenceType", boost::python::no_init);
}