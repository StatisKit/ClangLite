...
void class_clang_obj_c_ivar_decl()
{
        ...
        boost::python::class_< class ::clang::ObjCIvarDecl, class ::clang::ObjCIvarDecl *, boost::python::bases< class ::clang::FieldDecl >, boost::noncopyable >("ObjCIvarDecl", boost::python::no_init);
}