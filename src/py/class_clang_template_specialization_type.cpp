...
void class_clang_template_specialization_type()
{
        ...
        boost::python::class_< class ::clang::TemplateSpecializationType, class ::clang::TemplateSpecializationType *, boost::python::bases< class ::clang::Type >, boost::noncopyable >("TemplateSpecializationType", boost::python::no_init);
}