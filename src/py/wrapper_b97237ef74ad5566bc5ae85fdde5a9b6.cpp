...
void wrapper_b97237ef74ad5566bc5ae85fdde5a9b6(pybind11::module& module)
{
    ...
    {
        static class ::pybind11::list  function_2918fad8c2ff5268b6d763ec72d2dbff(class ::clang::DeclContext & parameter_0)
    ...
    pybind11::class_<class ::clang::DeclContext, autowig::HolderType< class ::clang::DeclContext >::Type > class_b97237ef74ad5566bc5ae85fdde5a9b6(module, "DeclContext", "");
    class_b97237ef74ad5566bc5ae85fdde5a9b6.def("get_decl_kind", method_pointer_28c24fdc140056a0b868244f21cfe876, "");
    class_b97237ef74ad5566bc5ae85fdde5a9b6.def("get_parent", method_pointer_43ccc9c9ca885ac2b9d01bf0ce13c6ba, pybind11::return_value_policy::reference_internal, ":Return Type:\n    :cpp:class:`::clang::DeclContext`\n\n");
    class_b97237ef74ad5566bc5ae85fdde5a9b6.def("get_parent", method_pointer_a8bd33c5a0c35c9d8c7f7dbee5a150d4, pybind11::return_value_policy::reference_internal, "");
    class_b97237ef74ad5566bc5ae85fdde5a9b6.def("get_lexical_parent", method_pointer_ad3342c5e59652a1810f13876474c71c, pybind11::return_value_policy::reference_internal, ":Return Type:\n    :cpp:class:`::clang::DeclContext`\n\n");
    class_b97237ef74ad5566bc5ae85fdde5a9b6.def("get_lexical_parent", method_pointer_bf6352a704a453ab9747da20ed98a7ef, pybind11::return_value_policy::reference_internal, "");
    ...
    class_b97237ef74ad5566bc5ae85fdde5a9b6.def("get_extern_c_context", method_pointer_69213aeec039585a900d8b1c0eae4f10, pybind11::return_value_policy::reference_internal, "Retrieve the nearest enclosing C linkage specification context.\n\n:Return Type:\n    :cpp:class:`::clang::LinkageSpecDecl`\n\n");
    ...
    class_b97237ef74ad5566bc5ae85fdde5a9b6.def("get_non_closure_ancestor", method_pointer_fc3ef3b589cf59adb30e0b32e0e0c6ee, pybind11::return_value_policy::reference_internal, "Find the nearest non-closure ancestor of this context, i.e. the\ninnermost semantic parent of this context which is not a closure. A\ncontext may be its own non-closure ancestor.\n\n:Return Type:\n    :cpp:class:`::clang::Decl`\n\n");
    class_b97237ef74ad5566bc5ae85fdde5a9b6.def("get_non_closure_ancestor", method_pointer_c41633e25df25c69b30fb736cf6a6726, pybind11::return_value_policy::reference_internal, "");
    class_b97237ef74ad5566bc5ae85fdde5a9b6.def("get_primary_context", method_pointer_87ee69f18f205e81b1bcf4c82cfebd89, pybind11::return_value_policy::reference_internal, ":Return Type:\n    :cpp:class:`::clang::DeclContext`\n\n");
    class_b97237ef74ad5566bc5ae85fdde5a9b6.def("get_primary_context", method_pointer_79f3559aabd35678b567322f14e60e44, pybind11::return_value_policy::reference_internal, "");
    class_b97237ef74ad5566bc5ae85fdde5a9b6.def("get_redecl_context", method_pointer_793a1c590ab85137bc818335b12d9a36, pybind11::return_value_policy::reference_internal, ":Return Type:\n    :cpp:class:`::clang::DeclContext`\n\n");
    class_b97237ef74ad5566bc5ae85fdde5a9b6.def("get_redecl_context", method_pointer_9077739098fc5e5fa5fcd99dc2b9372d, pybind11::return_value_policy::reference_internal, "");
    class_b97237ef74ad5566bc5ae85fdde5a9b6.def("get_enclosing_namespace_context", method_pointer_3f4349c6ca9555eaa7a21ce3912f4061, pybind11::return_value_policy::reference_internal, "Retrieve the nearest enclosing namespace context.\n\n:Return Type:\n    :cpp:class:`::clang::DeclContext`\n\n");
    class_b97237ef74ad5566bc5ae85fdde5a9b6.def("get_enclosing_namespace_context", method_pointer_6cb74f7a0406533d955a81eb5edb2c14, pybind11::return_value_policy::reference_internal, "");
    class_b97237ef74ad5566bc5ae85fdde5a9b6.def("get_outer_lexical_record_context", method_pointer_8f817c0a2a665ba5b91a8d385d2723b2, pybind11::return_value_policy::reference_internal, "Retrieve the outermost lexically enclosing record context.\n\n:Return Type:\n    :cpp:class:`::clang::RecordDecl`\n\n");
    class_b97237ef74ad5566bc5ae85fdde5a9b6.def("get_outer_lexical_record_context", method_pointer_cc2bd58923a05a4887356f9682272398, pybind11::return_value_policy::reference_internal, "");
    class_b97237ef74ad5566bc5ae85fdde5a9b6.def("in_enclosing_namespace_set_of", method_pointer_f7817d3dcec2515e9e55ff0502f9f333, "Test if this context is part of the enclosing namespace set of the\ncontext NS, as defined in C++0x [namespace.def]p9. If either context\nisn’t a namespace, this is equivalent to Equals().\n\nThe enclosing namespace set of a namespace is the namespace and, if it\nis inline, its enclosing namespace, recursively.\n\n:Parameter:\n    `NS` (:cpp:class:`::clang::DeclContext`) - Undocumented\n\n:Return Type:\n    :cpp:any:`bool`\n\n");
    ...
    class_b97237ef74ad5566bc5ae85fdde5a9b6.def_static("classof", method_pointer_4533db9809cf5c26a8ae67ba251dd361, "");
    class_b97237ef74ad5566bc5ae85fdde5a9b6.def_static("classof", method_pointer_087c6fc3b75e5f48901abdda8b340374, "");
    ...
    class_b97237ef74ad5566bc5ae85fdde5a9b6.def("as_translation_unit", function_group::function_a4fd994e51fd58818507ad61d92d875a, pybind11::return_value_policy::reference, "");
    class_b97237ef74ad5566bc5ae85fdde5a9b6.def("as_namespace", function_group::function_2a86b0e3c9625c72b24b6ab56afb8000, pybind11::return_value_policy::reference, "");
    class_b97237ef74ad5566bc5ae85fdde5a9b6.def("as_record", function_group::function_e8c5d7782e8b5cfab870044661d2bc9b, pybind11::return_value_policy::reference, "");
    class_b97237ef74ad5566bc5ae85fdde5a9b6.def("as_enum", function_group::function_cf5f5e5e745153b88255965b3ae2b2f7, pybind11::return_value_policy::reference, "");
