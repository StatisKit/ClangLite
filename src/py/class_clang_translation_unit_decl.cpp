...
void class_clang_translation_unit_decl()
{
        ...
        boost::python::class_< class ::clang::TranslationUnitDecl, class ::clang::TranslationUnitDecl *, boost::python::bases< class ::clang::Decl, class ::clang::DeclContext >, boost::noncopyable >("TranslationUnitDecl", boost::python::no_init);
}