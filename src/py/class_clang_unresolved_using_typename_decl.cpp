...
void class_clang_unresolved_using_typename_decl()
{
        ...
        boost::python::class_< class ::clang::UnresolvedUsingTypenameDecl, class ::clang::UnresolvedUsingTypenameDecl *, boost::python::bases< class ::clang::TypeDecl >, boost::noncopyable >("UnresolvedUsingTypenameDecl", boost::python::no_init);
}