...
void wrapper_973074796ca857b3a9a2c7a922cd35ae()
{
    ...
    bool  (*method_pointer_1280f26b96f651968f38a0e168756239)(class ::clang::Type  const *) = ::clang::DecltypeType::classof;
    bool  (::clang::DecltypeType::*method_pointer_c9d2ac9bb7bf5cc7a1358a589e094605)() const = &::clang::DecltypeType::isSugared;
    ...
    class_973074796ca857b3a9a2c7a922cd35ae.def("classof", method_pointer_1280f26b96f651968f38a0e168756239, "");
    class_973074796ca857b3a9a2c7a922cd35ae.def("is_sugared", method_pointer_c9d2ac9bb7bf5cc7a1358a589e094605, "");
