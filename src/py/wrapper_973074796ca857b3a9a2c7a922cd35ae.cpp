...
void wrapper_973074796ca857b3a9a2c7a922cd35ae()
{
    ...
    bool  (::clang::DecltypeType::*method_pointer_cb3036a788115f4a862910cae93abacf)() const = &::clang::DecltypeType::isSugared;
    bool  (*method_pointer_4121d69a637851ba95d8844a3112754d)(class ::clang::Type  const *) = ::clang::DecltypeType::classof;
    ...
    class_973074796ca857b3a9a2c7a922cd35ae.def("is_sugared", method_pointer_cb3036a788115f4a862910cae93abacf, "");
    class_973074796ca857b3a9a2c7a922cd35ae.def("classof", method_pointer_4121d69a637851ba95d8844a3112754d, "");
