...
void wrapper_973074796ca857b3a9a2c7a922cd35ae()
{
    ...
    bool  (*method_pointer_3400afab39905004b6897aa4923f88a9)(class ::clang::Type  const *) = ::clang::DecltypeType::classof;
    bool  (::clang::DecltypeType::*method_pointer_db20a8b7783a57a785af367a16f56af3)() const = &::clang::DecltypeType::isSugared;
    ...
    class_973074796ca857b3a9a2c7a922cd35ae.def("classof", method_pointer_3400afab39905004b6897aa4923f88a9, "");
    class_973074796ca857b3a9a2c7a922cd35ae.def("is_sugared", method_pointer_db20a8b7783a57a785af367a16f56af3, "");
