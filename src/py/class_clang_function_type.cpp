...
void class_clang_function_type()
{
        ...
        boost::python::class_< class ::clang::FunctionType, class ::clang::FunctionType *, boost::python::bases< class ::clang::Type >, boost::noncopyable >("FunctionType", boost::python::no_init);
}