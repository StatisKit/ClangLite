...
void class_clang_implicit_param_decl()
{
        ...
        boost::python::class_< class ::clang::ImplicitParamDecl, class ::clang::ImplicitParamDecl *, boost::python::bases< class ::clang::VarDecl >, boost::noncopyable >("ImplicitParamDecl", boost::python::no_init);
}