...
void class_clang_atomic_type()
{
        ...
        boost::python::class_< class ::clang::AtomicType, class ::clang::AtomicType *, boost::python::bases< class ::clang::Type >, boost::noncopyable >("AtomicType", boost::python::no_init);
}