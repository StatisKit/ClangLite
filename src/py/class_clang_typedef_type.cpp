...
void class_clang_typedef_type()
{
        ...
        boost::python::class_< class ::clang::TypedefType, class ::clang::TypedefType *, boost::python::bases< class ::clang::Type >, boost::noncopyable >("TypedefType", boost::python::no_init);
}