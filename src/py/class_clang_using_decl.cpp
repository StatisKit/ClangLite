...
void class_clang_using_decl()
{
        ...
        boost::python::class_< class ::clang::UsingDecl, class ::clang::UsingDecl *, boost::python::bases< class ::clang::NamedDecl >, boost::noncopyable >("UsingDecl", boost::python::no_init);
}