...
void class_clang_template_template_parm_decl()
{
        ...
        boost::python::class_< class ::clang::TemplateTemplateParmDecl, class ::clang::TemplateTemplateParmDecl *, boost::python::bases< class ::clang::TemplateDecl >, boost::noncopyable >("TemplateTemplateParmDecl", boost::python::no_init);
}