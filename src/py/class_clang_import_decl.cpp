...
void class_clang_import_decl()
{
        ...
        boost::python::class_< class ::clang::ImportDecl, class ::clang::ImportDecl *, boost::python::bases< class ::clang::Decl >, boost::noncopyable >("ImportDecl", boost::python::no_init);
}