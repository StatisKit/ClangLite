...
void wrapper_8f4ae14067765cbda7d29e287116fb17()
{
    ...
    class ::clang::ASTUnit  * (*function_pointer_8f4ae14067765cbda7d29e287116fb17)(class ::boost::python::api::object , class ::boost::python::api::object ) = ::clanglite::build_ast_from_code_with_args;
    boost::python::def("build_ast_from_code_with_args", function_pointer_8f4ae14067765cbda7d29e287116fb17, boost::python::return_value_policy< boost::python::reference_existing_object >(), "");
}