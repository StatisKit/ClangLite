...
void class_clang_omp_thread_private_decl()
{
        ...
        boost::python::class_< class ::clang::OMPThreadPrivateDecl, class ::clang::OMPThreadPrivateDecl *, boost::python::bases< class ::clang::Decl >, boost::noncopyable >("OMPThreadPrivateDecl", boost::python::no_init);
}