...
void wrapper_99d3396ee242572bbeaada83b5e83165(pybind11::module& module)
{
    ...
    pybind11::class_<class ::clang::VarDecl, autowig::HolderType< class ::clang::VarDecl >::Type, class ::clang::DeclaratorDecl > class_99d3396ee242572bbeaada83b5e83165(module, "VarDecl", "");
    class_99d3396ee242572bbeaada83b5e83165.def_static("create_deserialized", method_pointer_ac51e5e24e13528d940b9808ad62a034, pybind11::return_value_policy::reference_internal, "");
    ...
    class_99d3396ee242572bbeaada83b5e83165.def("has_external_storage", method_pointer_9dd66f0f60e952b88651753da9b4f495, "Returns true if a variable has extern or **private_extern** storage.\n\n:Return Type:\n    :cpp:any:`bool`\n\n");
    ...
    class_99d3396ee242572bbeaada83b5e83165.def("get_canonical_decl", method_pointer_f260795216305ff2a615522ffc686b11, pybind11::return_value_policy::reference_internal, "");
    class_99d3396ee242572bbeaada83b5e83165.def("get_canonical_decl", method_pointer_614e7a45eaec51b3981b4cbb76926fc9, pybind11::return_value_policy::reference_internal, "");
    class_99d3396ee242572bbeaada83b5e83165.def("get_acting_definition", method_pointer_b18e7d314fb05545a6fdcf4e4380aa33, pybind11::return_value_policy::reference_internal, "Get the tentative definition that acts as the real definition in a TU.\nReturns null if there is a proper definition available.\n\n:Return Type:\n    :cpp:class:`::clang::VarDecl`\n\n");
    class_99d3396ee242572bbeaada83b5e83165.def("get_acting_definition", method_pointer_0e72a8334de45f3694991321fb87122e, pybind11::return_value_policy::reference_internal, "");
    class_99d3396ee242572bbeaada83b5e83165.def("get_definition", method_pointer_d5059f9c025859f6a1e9084678087a15, pybind11::return_value_policy::reference_internal, "Get the real (not just tentative) definition for this declaration.\n\n:Parameter:\n    `` (:cpp:class:`::clang::ASTContext`) - Undocumented\n\n:Return Type:\n    :cpp:class:`::clang::VarDecl`\n\n");
    class_99d3396ee242572bbeaada83b5e83165.def("get_definition", method_pointer_b3036af34e815270983abf41eed9154f, pybind11::return_value_policy::reference_internal, "");
    class_99d3396ee242572bbeaada83b5e83165.def("get_definition", method_pointer_0fd9ceffd6b75e0096ac58ae15d4c470, pybind11::return_value_policy::reference_internal, "");
    class_99d3396ee242572bbeaada83b5e83165.def("get_definition", method_pointer_e1bfeb2262b45a3790fd3bd9cb2e84fb, pybind11::return_value_policy::reference_internal, "");
    ...
    class_99d3396ee242572bbeaada83b5e83165.def("is_arc_pseudo_strong", method_pointer_49d53c171a2b52d1a9a4c877cb527bbb, "Determine whether this variable is an ARC pseudo-__strong variable. A\npseudo-__strong variable has a \\__strong-qualified type but does not\nactually retain the object written into it. Generally such variables are\nalso ‘const’ for safety.\n\n:Return Type:\n    :cpp:any:`bool`\n\n");
    ...
    class_99d3396ee242572bbeaada83b5e83165.def("get_template_instantiation_pattern", method_pointer_6080b5bc99aa57eab474c5184a73810c, pybind11::return_value_policy::reference_internal, "Retrieve the variable declaration from which this variable could be\ninstantiated, if it is an instantiation (rather than a non-template).\n\n:Return Type:\n    :cpp:class:`::clang::VarDecl`\n\n");
    class_99d3396ee242572bbeaada83b5e83165.def("get_instantiated_from_static_data_member", method_pointer_4f0729409b075174b34f5a5e76f7817e, pybind11::return_value_policy::reference_internal, "If this variable is an instantiated static data member of a class\ntemplate specialization, returns the templated static data member from\nwhich it was instantiated.\n\n:Return Type:\n    :cpp:class:`::clang::VarDecl`\n\n");
