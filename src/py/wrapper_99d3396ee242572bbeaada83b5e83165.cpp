...
void wrapper_99d3396ee242572bbeaada83b5e83165()
{
    ...
    bool  (::clang::VarDecl::*method_pointer_ff413021808d55679fc3415cd127d0f0)() const = &::clang::VarDecl::isThisDeclarationADemotedDefinition;
    void  (::clang::VarDecl::*method_pointer_d864cc72000d59b9a17afb9fc1bc13cc)() = &::clang::VarDecl::demoteThisDefinitionToDeclaration;
    ...
    bool  (::clang::VarDecl::*method_pointer_e5c8c9f271315affa278b8a282a0bc7e)() const = &::clang::VarDecl::isInline;
    bool  (::clang::VarDecl::*method_pointer_d1b8286256f45848a956327f9c8751c6)() const = &::clang::VarDecl::isInlineSpecified;
    void  (::clang::VarDecl::*method_pointer_f0c2b6f659d35af1bc035f8ed124d5e4)() = &::clang::VarDecl::setInlineSpecified;
    void  (::clang::VarDecl::*method_pointer_69821190677c53d984933b0a59af0f04)() = &::clang::VarDecl::setImplicitlyInline;
    ...
    class ::clang::VarDecl * (::clang::VarDecl::*method_pointer_6080b5bc99aa57eab474c5184a73810c)() const = &::clang::VarDecl::getTemplateInstantiationPattern;
    ...
    class_99d3396ee242572bbeaada83b5e83165.def("is_this_declaration_a_demoted_definition", method_pointer_ff413021808d55679fc3415cd127d0f0, "If this definition should pretend to be a declaration.\n\n:Return Type:\n    :cpp:any:`bool`\n\n");
    class_99d3396ee242572bbeaada83b5e83165.def("demote_this_definition_to_declaration", method_pointer_d864cc72000d59b9a17afb9fc1bc13cc, "This is a definition which should be demoted to a declaration.\n\nIn some cases (mostly module merging) we can end up with two visible\ndefinitions one of which needs to be demoted to a declaration to keep\nthe AST invariants.\n\n:Return Type:\n    :cpp:any:`void`\n\n");
    ...
    class_99d3396ee242572bbeaada83b5e83165.def("is_inline", method_pointer_e5c8c9f271315affa278b8a282a0bc7e, ":Return Type:\n    :cpp:any:`bool`\n\n");
    class_99d3396ee242572bbeaada83b5e83165.def("is_inline_specified", method_pointer_d1b8286256f45848a956327f9c8751c6, "");
    class_99d3396ee242572bbeaada83b5e83165.def("set_inline_specified", method_pointer_f0c2b6f659d35af1bc035f8ed124d5e4, "");
    class_99d3396ee242572bbeaada83b5e83165.def("set_implicitly_inline", method_pointer_69821190677c53d984933b0a59af0f04, "");
    ...
    class_99d3396ee242572bbeaada83b5e83165.def("get_template_instantiation_pattern", method_pointer_6080b5bc99aa57eab474c5184a73810c, boost::python::return_value_policy< boost::python::reference_existing_object >(), "Retrieve the variable declaration from which this variable could be\ninstantiated, if it is an instantiation (rather than a non-template).\n\n:Return Type:\n    :py:class:`clanglite.clang.VarDecl`\n\n");
