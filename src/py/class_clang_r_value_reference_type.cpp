...
void class_clang_r_value_reference_type()
{
        ...
        boost::python::class_< class ::clang::RValueReferenceType, class ::clang::RValueReferenceType *, boost::python::bases< class ::clang::ReferenceType >, boost::noncopyable >("RValueReferenceType", boost::python::no_init);
}