...
void class_clang_dependent_sized_ext_vector_type()
{
        ...
        boost::python::class_< class ::clang::DependentSizedExtVectorType, class ::clang::DependentSizedExtVectorType *, boost::python::bases< class ::clang::Type >, boost::noncopyable >("DependentSizedExtVectorType", boost::python::no_init);
}
