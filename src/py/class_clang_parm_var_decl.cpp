...
void class_clang_parm_var_decl()
{
        ...
        boost::python::class_< class ::clang::ParmVarDecl, class ::clang::ParmVarDecl *, boost::python::bases< class ::clang::VarDecl >, boost::noncopyable >("ParmVarDecl", boost::python::no_init);
}