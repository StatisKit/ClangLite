...
void class_clang_obj_c_interface_decl()
{
        ...
        boost::python::class_< class ::clang::ObjCInterfaceDecl, class ::clang::ObjCInterfaceDecl *, boost::python::bases< class ::clang::ObjCContainerDecl >, boost::noncopyable >("ObjCInterfaceDecl", boost::python::no_init);
}