...
void class_clang_unresolved_using_type()
{
        ...
        boost::python::class_< class ::clang::UnresolvedUsingType, class ::clang::UnresolvedUsingType *, boost::python::bases< class ::clang::Type >, boost::noncopyable >("UnresolvedUsingType", boost::python::no_init);
}