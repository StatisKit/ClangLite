...
void class_clang_subst_template_type_parm_type()
{
        ...
        boost::python::class_< class ::clang::SubstTemplateTypeParmType, class ::clang::SubstTemplateTypeParmType *, boost::python::bases< class ::clang::Type >, boost::noncopyable >("SubstTemplateTypeParmType", boost::python::no_init);
}