...
void class_clang_decayed_type()
{
        ...
        boost::python::class_< class ::clang::DecayedType, class ::clang::DecayedType *, boost::python::bases< class ::clang::AdjustedType >, boost::noncopyable >("DecayedType", boost::python::no_init);
}