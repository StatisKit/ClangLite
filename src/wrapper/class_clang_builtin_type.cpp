...
void class_clang_builtin_type()
{
        ...
        boost::python::class_< class ::clang::BuiltinType, class ::clang::BuiltinType *, boost::python::bases< class ::clang::Type >, boost::noncopyable >("BuiltinType", boost::python::no_init);
}