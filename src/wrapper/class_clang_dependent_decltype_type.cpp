...
void class_clang_dependent_decltype_type()
{
        ...
        boost::python::class_< class ::clang::DependentDecltypeType, class ::clang::DependentDecltypeType *, boost::python::bases< class ::clang::DecltypeType >, boost::noncopyable >("DependentDecltypeType", boost::python::no_init);
}