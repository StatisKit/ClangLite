...
void class_clang_label_decl()
{
        ...
        boost::python::class_< class ::clang::LabelDecl, class ::clang::LabelDecl *, boost::python::bases< class ::clang::NamedDecl >, boost::noncopyable >("LabelDecl", boost::python::no_init);
}