...
void class_clang_captured_decl()
{
        ...
        boost::python::class_< class ::clang::CapturedDecl, class ::clang::CapturedDecl *, boost::python::bases< class ::clang::Decl, class ::clang::DeclContext >, boost::noncopyable >("CapturedDecl", boost::python::no_init);
}