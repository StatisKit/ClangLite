...
void class_clang_function_proto_type()
{
        ...
        boost::python::class_< class ::clang::FunctionProtoType, class ::clang::FunctionProtoType *, boost::python::bases< class ::clang::FunctionType >, boost::noncopyable >("FunctionProtoType", boost::python::no_init);
}