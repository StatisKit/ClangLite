...
void class_clang_declarator_decl()
{
        ...
        boost::python::class_< class ::clang::DeclaratorDecl, class ::clang::DeclaratorDecl *, boost::python::bases< class ::clang::ValueDecl >, boost::noncopyable >("DeclaratorDecl", boost::python::no_init);
}