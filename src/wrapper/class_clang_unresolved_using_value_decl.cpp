...
void class_clang_unresolved_using_value_decl()
{
        ...
        boost::python::class_< class ::clang::UnresolvedUsingValueDecl, class ::clang::UnresolvedUsingValueDecl *, boost::python::bases< class ::clang::ValueDecl >, boost::noncopyable >("UnresolvedUsingValueDecl", boost::python::no_init);
}