...
void class_clang_typedef_decl()
{
        ...
        boost::python::class_< class ::clang::TypedefDecl, class ::clang::TypedefDecl *, boost::python::bases< class ::clang::TypedefNameDecl >, boost::noncopyable >("TypedefDecl", boost::python::no_init);
}