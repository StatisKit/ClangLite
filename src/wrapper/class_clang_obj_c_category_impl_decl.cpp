...
void class_clang_obj_c_category_impl_decl()
{
        ...
        boost::python::class_< class ::clang::ObjCCategoryImplDecl, class ::clang::ObjCCategoryImplDecl *, boost::python::bases< class ::clang::ObjCImplDecl >, boost::noncopyable >("ObjCCategoryImplDecl", boost::python::no_init);
}