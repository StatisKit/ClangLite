...
void class_clang_decltype_type()
{
        ...
        boost::python::class_< class ::clang::DecltypeType, class ::clang::DecltypeType *, boost::python::bases< class ::clang::Type >, boost::noncopyable >("DecltypeType", boost::python::no_init);
}