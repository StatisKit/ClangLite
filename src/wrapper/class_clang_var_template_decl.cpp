...
void class_clang_var_template_decl()
{
        ...
        boost::python::class_< class ::clang::VarTemplateDecl, class ::clang::VarTemplateDecl *, boost::python::bases< class ::clang::RedeclarableTemplateDecl >, boost::noncopyable >("VarTemplateDecl", boost::python::no_init);
}