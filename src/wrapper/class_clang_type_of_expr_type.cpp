...
void class_clang_type_of_expr_type()
{
        ...
        boost::python::class_< class ::clang::TypeOfExprType, class ::clang::TypeOfExprType *, boost::python::bases< class ::clang::Type >, boost::noncopyable >("TypeOfExprType", boost::python::no_init);
}