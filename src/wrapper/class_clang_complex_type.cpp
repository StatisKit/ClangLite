...
void class_clang_complex_type()
{
        ...
        boost::python::class_< class ::clang::ComplexType, class ::clang::ComplexType *, boost::python::bases< class ::clang::Type >, boost::noncopyable >("ComplexType", boost::python::no_init);
}