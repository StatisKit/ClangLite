...
void class_clang_cxx_destructor_decl()
{
        ...
        boost::python::class_< class ::clang::CXXDestructorDecl, class ::clang::CXXDestructorDecl *, boost::python::bases< class ::clang::CXXMethodDecl >, boost::noncopyable >("CXXDestructorDecl", boost::python::no_init);
}