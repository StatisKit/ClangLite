...
void class_clang_cxx_conversion_decl()
{
        ...
        boost::python::class_< class ::clang::CXXConversionDecl, class ::clang::CXXConversionDecl *, boost::python::bases< class ::clang::CXXMethodDecl >, boost::noncopyable >("CXXConversionDecl", boost::python::no_init);
}