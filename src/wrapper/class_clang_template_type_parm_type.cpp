...
void class_clang_template_type_parm_type()
{
        ...
        boost::python::class_< class ::clang::TemplateTypeParmType, class ::clang::TemplateTypeParmType *, boost::python::bases< class ::clang::Type >, boost::noncopyable >("TemplateTypeParmType", boost::python::no_init);
}