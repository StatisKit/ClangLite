...
void class_clang_dependent_type_of_expr_type()
{
        ...
        boost::python::class_< class ::clang::DependentTypeOfExprType, class ::clang::DependentTypeOfExprType *, boost::python::bases< class ::clang::TypeOfExprType >, boost::noncopyable >("DependentTypeOfExprType", boost::python::no_init);
}