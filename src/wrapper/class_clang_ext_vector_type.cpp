...
void class_clang_ext_vector_type()
{
        ...
        boost::python::class_< class ::clang::ExtVectorType, class ::clang::ExtVectorType *, boost::python::bases< class ::clang::VectorType >, boost::noncopyable >("ExtVectorType", boost::python::no_init);
}