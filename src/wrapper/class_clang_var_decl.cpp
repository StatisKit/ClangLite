...
void class_clang_var_decl()
{
        ...
        boost::python::class_< class ::clang::VarDecl, class ::clang::VarDecl *, boost::python::bases< class ::clang::DeclaratorDecl >, boost::noncopyable >("VarDecl", boost::python::no_init);
}