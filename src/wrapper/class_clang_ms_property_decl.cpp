...
void class_clang_ms_property_decl()
{
        ...
        boost::python::class_< class ::clang::MSPropertyDecl, class ::clang::MSPropertyDecl *, boost::python::bases< class ::clang::DeclaratorDecl >, boost::noncopyable >("MSPropertyDecl", boost::python::no_init);
}