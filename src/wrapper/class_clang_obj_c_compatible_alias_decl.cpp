...
void class_clang_obj_c_compatible_alias_decl()
{
        ...
        boost::python::class_< class ::clang::ObjCCompatibleAliasDecl, class ::clang::ObjCCompatibleAliasDecl *, boost::python::bases< class ::clang::NamedDecl >, boost::noncopyable >("ObjCCompatibleAliasDecl", boost::python::no_init);
}