...
void class_clang_var_template_specialization_decl()
{
        ...
        boost::python::class_< class ::clang::VarTemplateSpecializationDecl, class ::clang::VarTemplateSpecializationDecl *, boost::python::bases< class ::clang::VarDecl >, boost::noncopyable >("VarTemplateSpecializationDecl", boost::python::no_init);
}