...
void class_clang_incomplete_array_type()
{
        ...
        boost::python::class_< class ::clang::IncompleteArrayType, class ::clang::IncompleteArrayType *, boost::python::bases< class ::clang::ArrayType >, boost::noncopyable >("IncompleteArrayType", boost::python::no_init);
}