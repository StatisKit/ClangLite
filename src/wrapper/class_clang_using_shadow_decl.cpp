...
void class_clang_using_shadow_decl()
{
        ...
        boost::python::class_< class ::clang::UsingShadowDecl, class ::clang::UsingShadowDecl *, boost::python::bases< class ::clang::NamedDecl >, boost::noncopyable >("UsingShadowDecl", boost::python::no_init);
}