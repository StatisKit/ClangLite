...
void class_clang_using_directive_decl()
{
        ...
        boost::python::class_< class ::clang::UsingDirectiveDecl, class ::clang::UsingDirectiveDecl *, boost::python::bases< class ::clang::NamedDecl >, boost::noncopyable >("UsingDirectiveDecl", boost::python::no_init);
}