...
void class_clang_type_alias_decl()
{
        ...
        boost::python::class_< class ::clang::TypeAliasDecl, class ::clang::TypeAliasDecl *, boost::python::bases< class ::clang::TypedefNameDecl >, boost::noncopyable >("TypeAliasDecl", boost::python::no_init);
}