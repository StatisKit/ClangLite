...
void class_clang_type_decl()
{
        ...
        boost::python::class_< class ::clang::TypeDecl, class ::clang::TypeDecl *, boost::python::bases< class ::clang::NamedDecl >, boost::noncopyable >("TypeDecl", boost::python::no_init);
}