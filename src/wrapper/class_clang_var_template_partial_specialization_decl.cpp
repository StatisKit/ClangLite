...
void class_clang_var_template_partial_specialization_decl()
{
        ...
        boost::python::class_< class ::clang::VarTemplatePartialSpecializationDecl, class ::clang::VarTemplatePartialSpecializationDecl *, boost::python::bases< class ::clang::VarTemplateSpecializationDecl >, boost::noncopyable >("VarTemplatePartialSpecializationDecl", boost::python::no_init);
}