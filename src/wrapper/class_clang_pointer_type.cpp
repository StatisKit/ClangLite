...
void class_clang_pointer_type()
{
        ...
        boost::python::class_< class ::clang::PointerType, class ::clang::PointerType *, boost::python::bases< class ::clang::Type >, boost::noncopyable >("PointerType", boost::python::no_init);
}