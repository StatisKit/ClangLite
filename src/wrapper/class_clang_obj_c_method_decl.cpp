...
void class_clang_obj_c_method_decl()
{
        ...
        boost::python::class_< class ::clang::ObjCMethodDecl, class ::clang::ObjCMethodDecl *, boost::python::bases< class ::clang::NamedDecl, class ::clang::DeclContext >, boost::noncopyable >("ObjCMethodDecl", boost::python::no_init);
}