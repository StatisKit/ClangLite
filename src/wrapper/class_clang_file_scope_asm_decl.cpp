...
void class_clang_file_scope_asm_decl()
{
        ...
        boost::python::class_< class ::clang::FileScopeAsmDecl, class ::clang::FileScopeAsmDecl *, boost::python::bases< class ::clang::Decl >, boost::noncopyable >("FileScopeAsmDecl", boost::python::no_init);
}