...
void class_clang_record_type()
{
        ...
        boost::python::class_< class ::clang::RecordType, class ::clang::RecordType *, boost::python::bases< class ::clang::TagType >, boost::noncopyable >("RecordType", boost::python::no_init);
}