...
void class_clang_class_scope_function_specialization_decl()
{
        ...
        boost::python::class_< class ::clang::ClassScopeFunctionSpecializationDecl, class ::clang::ClassScopeFunctionSpecializationDecl *, boost::python::bases< class ::clang::Decl >, boost::noncopyable >("ClassScopeFunctionSpecializationDecl", boost::python::no_init);
}