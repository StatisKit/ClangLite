...
void class_clang_namespace_alias_decl()
{
        ...
        boost::python::class_< class ::clang::NamespaceAliasDecl, class ::clang::NamespaceAliasDecl *, boost::python::bases< class ::clang::NamedDecl >, boost::noncopyable >("NamespaceAliasDecl", boost::python::no_init);
}