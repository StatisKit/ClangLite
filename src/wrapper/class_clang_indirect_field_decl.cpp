...
void class_clang_indirect_field_decl()
{
        ...
        boost::python::class_< class ::clang::IndirectFieldDecl, class ::clang::IndirectFieldDecl *, boost::python::bases< class ::clang::ValueDecl >, boost::noncopyable >("IndirectFieldDecl", boost::python::no_init);
}