...
void class_clang_template_type_parm_decl()
{
        ...
        boost::python::class_< class ::clang::TemplateTypeParmDecl, class ::clang::TemplateTypeParmDecl *, boost::python::bases< class ::clang::TypeDecl >, boost::noncopyable >("TemplateTypeParmDecl", boost::python::no_init);
}