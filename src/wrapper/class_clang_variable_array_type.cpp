...
void class_clang_variable_array_type()
{
        ...
        boost::python::class_< class ::clang::VariableArrayType, class ::clang::VariableArrayType *, boost::python::bases< class ::clang::ArrayType >, boost::noncopyable >("VariableArrayType", boost::python::no_init);
}