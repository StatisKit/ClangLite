...
void class_clang_record_decl()
{
        ...
        boost::python::class_< class ::clang::RecordDecl, class ::clang::RecordDecl *, boost::python::bases< class ::clang::TagDecl >, boost::noncopyable >("RecordDecl", boost::python::no_init);
}