...
void class_clang_extern_c_context_decl()
{
        ...
        boost::python::class_< class ::clang::ExternCContextDecl, class ::clang::ExternCContextDecl *, boost::python::bases< class ::clang::Decl, class ::clang::DeclContext >, boost::noncopyable >("ExternCContextDecl", boost::python::no_init);
}