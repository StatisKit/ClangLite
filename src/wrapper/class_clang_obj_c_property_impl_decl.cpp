...
void class_clang_obj_c_property_impl_decl()
{
        ...
        boost::python::class_< class ::clang::ObjCPropertyImplDecl, class ::clang::ObjCPropertyImplDecl *, boost::python::bases< class ::clang::Decl >, boost::noncopyable >("ObjCPropertyImplDecl", boost::python::no_init);
}