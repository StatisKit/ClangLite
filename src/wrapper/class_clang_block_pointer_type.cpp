...
void class_clang_block_pointer_type()
{
        ...
        boost::python::class_< class ::clang::BlockPointerType, class ::clang::BlockPointerType *, boost::python::bases< class ::clang::Type >, boost::noncopyable >("BlockPointerType", boost::python::no_init);
}