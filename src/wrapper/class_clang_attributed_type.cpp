...
void class_clang_attributed_type()
{
        ...
        boost::python::class_< class ::clang::AttributedType, class ::clang::AttributedType *, boost::python::bases< class ::clang::Type >, boost::noncopyable >("AttributedType", boost::python::no_init);
}