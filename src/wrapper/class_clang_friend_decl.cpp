...
void class_clang_friend_decl()
{
        ...
        boost::python::class_< class ::clang::FriendDecl, class ::clang::FriendDecl *, boost::python::bases< class ::clang::Decl >, boost::noncopyable >("FriendDecl", boost::python::no_init)
            .def("get_friend_decl", &::clang::FriendDecl::getFriendDecl, boost::python::return_value_policy< boost::python::reference_existing_object >());
}
