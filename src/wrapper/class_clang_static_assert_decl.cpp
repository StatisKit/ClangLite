...
void class_clang_static_assert_decl()
{
        ...
        boost::python::class_< class ::clang::StaticAssertDecl, class ::clang::StaticAssertDecl *, boost::python::bases< class ::clang::Decl >, boost::noncopyable >("StaticAssertDecl", boost::python::no_init);
}