...
void class_clang_block_decl()
{
        ...
        boost::python::class_< class ::clang::BlockDecl, class ::clang::BlockDecl *, boost::python::bases< class ::clang::Decl, class ::clang::DeclContext >, boost::noncopyable >("BlockDecl", boost::python::no_init);
}