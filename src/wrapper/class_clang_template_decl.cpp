...
void class_clang_template_decl()
{
        ...
        boost::python::class_< class ::clang::TemplateDecl, class ::clang::TemplateDecl *, boost::python::bases< class ::clang::NamedDecl >, boost::noncopyable >("TemplateDecl", boost::python::no_init);
}