...
void class_clang_obj_c_object_pointer_type()
{
        ...
        boost::python::class_< class ::clang::ObjCObjectPointerType, class ::clang::ObjCObjectPointerType *, boost::python::bases< class ::clang::Type >, boost::noncopyable >("ObjCObjectPointerType", boost::python::no_init);
}